...
export function BackOfficeWorkflow() {
    ...
    return (
        <div className="space-y-6">
            ...
            <Tabs defaultValue="profile-update" className="w-full">
                <TabsList className="grid w-full max-w-md grid-cols-2 mb-6">
                    <TabsTrigger value="profile-update" className="gap-2">
                        <Search className="size-4" />
                        Profile Update
                    </TabsTrigger>
                    <TabsTrigger value="data-export" className="gap-2">
                        <FileDown className="size-4" />
                        Data Export
                    </TabsTrigger>
                </TabsList>

                <TabsContent value="profile-update" className="mt-0">
                    <Card>
                        <CardHeader>
