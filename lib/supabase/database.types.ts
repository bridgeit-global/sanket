    ...
    Tables: {
      ...
      Visitor: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "Visitor_voter_id_VoterMaster_epic_number_fk"
            columns: ["voter_id"]
            isOneToOne: false
            referencedRelation: "VoterMaster"
            referencedColumns: ["epic_number"]
      ...
      VisitorService: {
        ...
        Relationships: [
          {
            foreignKeyName: "VisitorService_beneficiary_service_id_fkey"
          ...
          {
            foreignKeyName: "VisitorService_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "User"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "VisitorService_programme_id_fkey"
            columns: ["programme_id"]
            isOneToOne: false
            referencedRelation: "DailyProgramme"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "VisitorService_visitor_id_fkey"
            columns: ["visitor_id"]
            isOneToOne: false
