...
export function mapAddressMasterRow(row: Row): AddressMaster {
  return {
    ...
    houseNumberEn: String(row.house_number_en ?? row.houseNumberEn ?? ''),
    houseNumberMr: String(row.house_number_mr ?? row.houseNumberMr ?? ''),
    localityStreetEn: String(row.locality_street_en ?? row.localityStreetEn ?? ''),
    localityStreetMr: String(row.locality_street_mr ?? row.localityStreetMr ?? ''),
    townVillageEn: String(row.town_village_en ?? row.townVillageEn ?? ''),
    townVillageMr: String(row.town_village_mr ?? row.townVillageMr ?? ''),
